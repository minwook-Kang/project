	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					<li><a href="/admin/member/list"><i class="fa fa-dashboard"></i> 회원 관리</a></li>
					...
					<div class="col-md-12">
						<div class="row text-center">
							...
							<select name="searchType" style="width:180px; height:26px;">
								...
								<option value="nick"
									<c:out value="${cri.searchType eq 'nick'?'selected':''}"/>>닉네임</option>
								<option value="name"
									<c:out value="${cri.searchType eq 'name'?'selected':''}"/>>이름</option>
								<option value="all"
									<c:out value="${cri.searchType eq 'all'?'selected':''}"/>>아이디+닉네임+이름</option>
							</select> 
						...
						<div class="box" style="border: none;">
							<div class="box-body">
								<table class="table table-striped text-center">
									...
									<%-- 주문 리스트 출력 --%>
									<c:forEach items="${mbsList}" var="memberDTO">
										<tr>
											<td class="col-md-1">${memberDTO.mbs_id}</td>
											<td class="col-md-1">${memberDTO.mbs_nick}</td>
											<td class="col-md-1">${memberDTO.mbs_name}</td>
											<td class="col-md-1">${memberDTO.mbs_point}</td>
											<td class="col-md-2">${memberDTO.mbs_lastlogin}</td>
											<td class="col-md-2"><a	href="/admin/member/read${pm.makeSearch(pm.cri.page)}&mbs_id=${memberDTO.mbs_id}"
												style="color: black;">[${memberDTO.mbs_id} 상세보기]</a></td>
										</tr>
