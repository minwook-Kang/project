						...
						<div class="box box-primary">
							...
							<div class="box-body">
								...
								<div class="form-group">
									...
									<span class="form-control">${vo.pro_company}</span>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="exampleInputEmail1" style="width:40%; margin-right:10px;">수량</label> 
									<label for="exampleInputEmail1" style="width:40%;">판매여부</label><br /> 
							...
							<div class="box-footer">
								...
								<button id="btn_list" type="button" class="btn btn-primary" >상품 목록으로</button>
							</div>
