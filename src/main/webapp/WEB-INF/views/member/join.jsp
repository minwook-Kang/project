        		...
        		<div class="container" style="width: 70%; min-width: 900px; background-color: white; font-size: 14px;" >
					<form id="joinForm" action="/member/join" method="post">
							...
							* 아래 항목을 작성해주세요.<br><br><br>
							...
							<div class="form-group">
								<label for="inputMobile">* 휴대폰 번호</label> <input type="tel"
									class="form-control" id="mbs_phone" name="mbs_phone"
							...
							<div class="form-group">
								...
								<label><input type="radio" name="mbs_accept_e" value="Y" style="margin-left: 20px;" checked="checked"> 예</label>
	      						<label><input type="radio" name="mbs_accept_e" value="N" style="margin-left: 20px;"> 아니오</label>
							</div>
						</div>
						<div class="form-group text-center">
							...
							<button type="button" id="btn_cancle" class="btn btn-lignt">
