...
<head>
  ...
  <script src="/js/order/buyFromCart.js"></script>
  <!-- Bootstrap core CSS -->
								...
								<table class="table table-striped text-center" id="ordertbl">
									...
									<c:forEach items="${productList}" var="productVO" varStatus="i">
										<tr id="productVO_${productVO.pro_num}" class="productRow">
											...
											<td class="col-md-1">
												<p><fmt:formatNumber value="${productVO.pro_price*amountList[i.index]}" pattern="###,###,###" /></p>
											...
											<td class="col-md-1">
												<p><fmt:formatNumber value="${productVO.pro_discount*amountList[i.index]}" pattern="###,###,###" /></p>
											...
											<td class="col-md-1">
												<p><fmt:formatNumber value="${productVO.pro_price*amountList[i.index]-productVO.pro_discount*amountList[i.index]}"  pattern="###,###,###" /></p>
