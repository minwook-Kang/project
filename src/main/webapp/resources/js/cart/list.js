...
var updatePrice = function(){
	...
	$("input[name='check']:checked").each(function(i){
		...
		totalPay += parseInt($("input[name='pay_"+cart_code+"']").val())*amount;
	});
...
/* 상품-구매 버튼 클릭 */
var clickBuyBtn = function(pro_num, cart_code){

	var cart_amount = $("input[name='cart_amount_"+cart_code+"']").val();
	var url = "/order/buyFromCart?pro_num="+pro_num+"&ord_amount="+cart_amount;
	location.href = url;
}